...
function techub_theme_support(){
    ...
    register_nav_menus( array(
        'main-menu' => __( 'Main Menu', 'assignment' ),
		'footer-menu' => __( 'footer Menu', 'assignment' ),
    ) );
...
function add_theme_scripts() {
	...
	wp_enqueue_style( 'mycustom', get_template_directory_uri() . '/assets/css/custom.css', array(), '1.0', 'all' );
