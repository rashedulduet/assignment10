...
function assignment_menu(){
   wp_nav_menu( 
       array( 
           ...
           'menu_id'         => '',
           'container'      => '',
           'fallback_cb'     => 'assignment_Walker_Nav_Menu::fallback',
           'walker'     => new assignment_Walker_Nav_Menu,
       ) 
   ); 
}
// footer menu
function assignment_menu_footer(){
   wp_nav_menu( 
       array( 
...
// header logo section
function assignment_header_logo(){ 
    $header_side_logo = get_theme_mod('header_side_logo',get_template_directory_uri().'/assets/img/logo/logo.png'); 
    ?>
    <a href="<?php echo home_url( '/' ); ?>"><img src="<?php echo esc_url($header_side_logo); ?>" alt=""></a>
    <?php 
}
// footer logo section
function assignment_footer_logo(){ 
   $footer_logo = get_theme_mod('footer_logo',get_template_directory_uri().'/assets/img/logo/logo.png'); 
   ?>
   <a href="<?php echo home_url( '/' ); ?>"><img src="<?php echo esc_url($footer_logo); ?>" alt=""></a>
   <?php 
}
// assignment_header_social
function assignment_header_social(){ 
...
function assignment_footer_copyright(){ 
    $footer_copyright = get_theme_mod('footer_copyright',__('© 2021 <a>Mezban</a> Design by <a>FoxCoders</a>.', 'assignment')); 
    ?>
    <p class="tp-footer-copy-paragraph tp-footer-4-copy-paragraph"><?php echo assignment_kses($footer_copyright); ?></p>
    <?php 
}
...
*/
function assignment_kses( $allow_tags = '' ) {
	$allowed_html = [
        'svg' => array(
            'class' => true,
            'aria-hidden' => true,
...
function assignment_navigation(){
 ...
 */
function assignment_search_form( $form ) {
...
add_filter( 'get_search_form', 'assignment_search_form' );
